...
if(zeq_name)
  list(APPEND FIND_PACKAGES_DEFINES ZEQ_USE_ZEQ)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND ZEQ_DEPENDENT_LIBRARIES zeq)
  endif()
...
if(FlatBuffers_name)
  ...
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND ZEQ_DEPENDENT_LIBRARIES FlatBuffers)
  endif()
...
set(WSVOC_DEPENDS zeq;FlatBuffers)
